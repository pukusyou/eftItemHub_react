  ...
  const updates = [
    {
      date: "2026/02/02",
      title: "UIの更新",
      content: "全体的にUIを見直し、より使いやすくしました。",
    },
    {
      date: "2024/12/27",
      title: "Hideoutの情報を更新",
    ...
    },
    {
      ...
      content:
        "設備の名前を日本語・英語切り替えることができるようになりました。",
    },
    {
      date: "2023/08/14",
    ...
    },
    {
      ...
      title: "タスクマップを追加",
      content:
        "タスク選択画面で「Taskmap」をクリックすると見ることができます。",
    },
  ];
  ...
  return (
    <>
      <div className="min-h-screen">
        ...
        <section className="content-container mt-8">
          ...
          <div className="update-card mt-6">
            <p className="m-0 leading-relaxed text-text-secondary">
              このサイトは「Escape from
              Tarkov」のタスク、ハイドアウトに必要なアイテムを確認するためのものです。
          ...
          <div className="mt-6">
            <ol className="m-0 list-none p-0">
              {howToUse.map((step, index) => (
                ...
                >
                  <span className="flex h-8 w-8 min-w-8 items-center justify-center rounded-full bg-gradient-gold font-heading text-sm font-bold text-black">
                    {index + 1}
                  </span>
        ...
        <section className="mx-auto my-12 max-w-200 px-4">
          ...
          <div className="mt-6 rounded-lg border border-border bg-gradient-card p-6">
            <p className="m-0 text-[0.95rem] leading-[1.8] text-text-secondary">
              このサイトは
              <a
                href="https://wikiwiki.jp/eft/"
                className="text-accent-primary no-underline hover:text-amber-400"
              >
                Escape From Tarkov JPN Wiki
              </a>
              様の情報を利用しております。 Escape From Tarkov JPN
              Wiki様に感謝申し上げます。
              <br />
              また、BattlestateGames様にも最大級の感謝を申し上げます。
            </p>
          </div>
        </section>
      </div>
