...
function Footer({ pageName, pageUrl }: FooterProps) {
    ...
    <footer className="mt-auto border-t border-border bg-bg-secondary py-8">
      <div className="mx-auto max-w-6xl px-4">
        <div className="text-center">
          ...
          {/* Divider */}
          <div className="mx-auto mb-6 h-0.5 w-25 bg-gradient-gold" />
          ...
          {pageUrl && (
            <p className="mb-4 text-xs leading-relaxed text-text-muted">
              ...
              の「
              <a href={pageUrl} className="text-accent-info hover:underline">
                {pageName}
              </a>
              」記事の素材を使用しており、Creative Commons
